...
<head>
  ...
  <!-- For get current loation and use jQuery cookies plugin-->
  ...
  <div class="background-wrap">
    ...
    ?>
      <div class="row">
        ...
        ?>
          <h5><span id="city"><?php echo $locCity; ?></span> ,<span id="state"><?php echo $locState; ?></span></h5><br>
        </div>
...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyA28OjYnnhoa4DsZwGd8EPzRLKpLZhXQUQ&libraries=places&callback=initAutocomplete" async defer></script>
